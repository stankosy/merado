            ...
            {installedWallets.length ? (
              ...
              <>
                ...
                <div className="wallet-adapter-modal-middle">
                  ...
                  <button
                    type="button"
                    className="wallet-adapter-modal-middle-button shadow bg-gradient-to-r from-[#ff4293] to-[#ff9e48] text-white font-medium hover:from-[#ff4293] hover:to-[#ff9e48] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#ff9e48] focus:ring-offset-gray-900"
                    onClick={(event) =>
